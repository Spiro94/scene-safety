import { ArrowRight, Mail, Shield, TriangleAlert, User } from "lucide-react";
    ...
    return (
        <div className="flex min-h-screen">
                ...
                <div className="max-w-[400px] w-full flex flex-col gap-8">
                    ...
                    <form className="flex flex-col gap-[18px]" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="w-[18px] h-[18px] rounded border-[1.5px] border-border-light bg-input"></div>
            ...
            <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center p-15 relative overflow-hidden"
                ...
                <div className="flex flex-col gap-10 justify-center max-w-[480px]">
